...
Kun omat seurat on listattu _My Clubs_ -painikkeen kautta, voidaan mille tahansa käyttäjän omistamalle seuralle lisätä tai poistaa liikuntalajeja painamalla seuran kortin _Manage sports_-painiketta. Painike listaa seuralle jo lisätyt lajit ja antaa kentän johon voi kirjoittaa lisättävän lajin nimen. Tämän jälkeen painetaan _Add_-painiketta ja lisätty laji ilmestyy seuran lajien joukkoon, mikäli sitä ei siellä jo ennestään ole. Kirjasinkoolla ei ole merkitystä. Jokaisen lisätyn lajin vieressä on _Delete_-nappi, jota painamalla lajin voi poistaa kyseisen seuran tarjonnasta.

### Seuran tietojen editointi ja seuran poistaminen
_My Clubs_ -näkymästä valitaan haluttu seura painamalla _Edit_ -painiketta. Aukeaa sama lomake, jolla seura luotiin, mutta se sisältää jo lisätyt tiedot. Tietoja voidaan vapaasti muokata ja lisätä. Muutokset tallennetaan _Save changes_ -painikkeella. Jos seura halutaan poistaa tietokannasta, painetaan _Save changes_ -napin alla olevaa _Delete_ -painiketta. Seuran lisäksi poistuvat myös kaikki seuraan liittyvät arvostelut. Poistaminen varmistetaan pop up-ikkunnalla. 

### Seuran infonäkymän ja arvostelujen tarkastelu
_My Clubs_ -näkymästä valitaan haluttu seura ja painetaan _Reviews_ -painiketta. Kaikki seuran saamat arvostelut listataan uusimmasta vanhimpaan. _Info_-napista päästään aiemmin kuvattuun infoikkunaan, josta seuran kaikki tiedot löytyvät.
