...
def add_sport(club_id):
    if request.method == "GET":
        return render_template("sports/new_sport.html", form=SportForm(), club_id=club_id)

    form = SportForm(request.form)

    if not form.validate():
        return render_template("sports/new_sport.html", form=form, club_id=club_id)
    ...
    if sportExists is None:
        ...
        return render_template("sports/new_sport.html", form=SportForm(), club_id=club_id, message=message)
